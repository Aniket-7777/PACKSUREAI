...
import { X, Download, FileText, CheckCircle2, Shield, Calendar, Scale, Printer } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-3xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        {/* Notice Preview Sheet (Printable) */}
        <div className="flex-1 overflow-y-auto p-6 space-y-4 font-serif text-slate-900 bg-slate-100 print:bg-white print:p-0">
          {/* Official Letterhead */}
          ...
          <div className="text-xs font-sans text-slate-800 space-y-0.5">
            <div><b>TO:</b></div>
            <div className="font-bold">M/s {activeBrandName}</div>
          ...
          <div className="pt-4 flex justify-between items-end font-sans text-xs">
            <div className="text-[10px] text-slate-500 font-mono">
              Cryptographic Hash: SHA-256 Verified Digital Evidence Package
            </div>
            <div className="text-right">
              <div className="font-bold">Authorized Legal Metrology Inspector</div>
              <div className="text-[10px] text-slate-600">Department of Consumer Affairs (DoCA)</div>
            </div>
          </div>
        </div>
